    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1">
            ...
            <p>Easy cancellation policy is available in 24 hr</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 leading-relaxed">
          ...
          <p>
            This product is prepared daily with love by our experienced bakers.
            You can expect soft sponge layers, rich cream fillings, and a
            delightful aroma that adds joy to your celebration. Available in
            multiple sizes and customization options.
          </p>
          <p>
            We are committed to hygiene, quality, and timely delivery. Every
            cake is carefully packed to preserve its structure and taste during
            delivery.
          </p>
        </div>
      </div>
